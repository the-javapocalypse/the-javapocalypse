...
<table>
  ...
  <tr>
    <td width="50%" valign="top">
      ...
      <p><b>What I did</b></p>
      <ul>
        <li>Led PhyStack as Domain Technical Lead; roll-out from ~400k to ~1.8B monthly events</li>
        <li>Replaced Azure IoT Hub; ~40% estimated monthly ops cost reduction</li>
        <li>RBAC revamp; billing UI/services revamp</li>
    ...
    <td width="50%" valign="top">
      ...
      <p><b>What I did</b></p>
      <ul>
        <li>TransGuard visa-application automation (10ks)</li>
...
![](https://raw.githubusercontent.com/the-javapocalypse/the-javapocalypse/main/profile-3d-contrib/profile-night-view.svg)
